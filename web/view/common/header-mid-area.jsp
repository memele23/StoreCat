                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-12">
                        <div class="header-search">
                            <form action="#">
                                ...
                                <a href="#"><img src="${pageContext.request.contextPath}/img/search.png" alt="search" style="width: 103%; height: 103%;" /></i></a>
                    ...
                    <div class="col-lg-6 col-md-4 col-12">
                        <div class="logo-area text-center logo-xs-mrg">
                            <img src="${pageContext.request.contextPath}/img/logo.png" alt="logo" style="width: 70%; height:100%;" />
                        </div>
                    </div>
