...
public class AdminFilter implements Filter {
	...
	*/
	...
	HttpSession session=req.getSession();
         //kiem tra xem da dang nhap (account da ton tai tren session chua)
        Account account=(Account) session.getAttribute(CommonConst.SESSION_ACCOUNT);
        if (account==null) {
            //chua tunf dang nhap
            resq.sendRedirect(req.getContextPath()+"/authen?action=login");
            return;
        }else{
            //da dang nhap roi
            //kiem tra xem quyen cua account la cai gi
