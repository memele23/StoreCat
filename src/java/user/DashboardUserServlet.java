 ...
 * @author PC
 */
@WebServlet(name="DashboardUserServlet", urlPatterns={"/DashboardUserServlet"})
public class DashboardUserServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("view/user_use/dashboard/dashboard.jsp").forward(request, response);
    } 
